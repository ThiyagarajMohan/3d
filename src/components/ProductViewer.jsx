...
export function ProductViewer({ shape, color }) {
    return (<Canvas camera={{ position: [0, 0, 5.5], fov: 45 }} dpr={[1, 2]}>
      ...
      <Suspense fallback={null}>
        <Float speed={1} rotationIntensity={0.4} floatIntensity={0.6}>
          <mesh castShadow>
            ...
            <meshStandardMaterial color={color} metalness={0.8} roughness={0.18} emissive={color} emissiveIntensity={0.15}/>
          </mesh>
        </Float>
