  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="mx-auto mt-4 flex max-w-6xl items-center justify-between gap-3 rounded-full glass px-4 py-3 sm:px-6">
        <Link
          to="/"
          className="flex min-w-0 shrink-0 items-center gap-2 rounded-md outline-none ring-offset-background focus-visible:ring-2 focus-visible:ring-ring sm:gap-3"
        >
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          <a
            href={waUrlWithText(GENERAL_ORDER_WHATSAPP_MESSAGE)}
            target="_blank"
            rel="noreferrer"
            className="rounded-full bg-primary px-3 py-2 text-center text-sm font-medium text-primary-foreground shadow-[0_0_24px_color-mix(in_oklab,var(--color-primary)_45%,transparent)] transition-transform hover:scale-105 sm:px-4"
          >
            Order Now
          </a>
        </div>
