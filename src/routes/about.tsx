  ...
  head: () => ({
    meta: [
      { title: "About — 3D Three Axis Print Solutions" },
      {
        name: "description",
        content:
          "We combine 3D printing, laser engraving, and lighted presentation to ship personalised statues, crystals, lithophanes, and shadow-box art.",
      },
      { property: "og:title", content: "About — 3D Three Axis Print Solutions" },
      {
        property: "og:description",
        content:
          "Personalised 3D-printed gifts, laser crystals, and illuminated décor from YOUR photos.",
      },
    ],
  }),
});
