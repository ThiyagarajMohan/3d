  ...
  head: () => ({
    meta: [
      { title: "Contact — 3D Three Axis Print Solutions" },
      {
        name: "description",
        content:
          "WhatsApp or email us to order custom 3D printed gifts, crystals, lithophanes, and LED personalised art.",
      },
        ...
        >
          ...
          <Field label="What would you like?">
            <textarea
              ...
              placeholder="Product type, dates, quantities, references — anything that helps."
            />
          </Field>
          <button
            type="submit"
            className="w-full rounded-full bg-primary px-6 py-3 text-sm font-medium text-primary-foreground shadow-[0_0_30px_color-mix(in_oklab,var(--color-primary)_50%,transparent)] transition-transform hover:scale-[1.01] sm:text-base"
          >
        ...
        <div className="space-y-4 sm:space-y-5">
          <div className="rounded-2xl glass p-5 sm:p-6">
            ...
            <a
              ...
              className="mt-1 block font-display text-base break-all text-primary hover:underline sm:text-lg"
            >
              {BUSINESS_EMAIL}
            </a>
          </div>
          <div className="rounded-2xl glass p-5 sm:p-6">
            ...
            <a
              href={TEL_URL}
              className="mt-1 block font-display text-base text-foreground hover:underline sm:text-lg"
            >
              {PHONE_DISPLAY}
            </a>
          </div>
          <div className="rounded-2xl glass p-5 sm:p-6">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-1 block font-display text-base text-primary hover:underline sm:text-lg"
            >
              {PHONE_DISPLAY}
            </a>
